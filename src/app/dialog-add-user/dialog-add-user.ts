import { Component, inject, runInInjectionContext, EnvironmentInjector, signal } from '@angular/core';
...
export class DialogAddUser {
    ...
    // ✅ Signal statt boolean (zoneless-safe)
    ...
    async saveUser() {
        ...
        try {
            ...
            // ✅ NUR wenn Speichern erfolgreich war: Formular leeren
            this.user = new User();
